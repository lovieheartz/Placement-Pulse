...
import { FiHome, FiUsers, FiUserPlus, FiUserX, FiMenu, FiX, FiChevronDown, FiBriefcase, FiBell, FiClipboard } from 'react-icons/fi';
...
const HODSidebar = () => {
  ...
  const handleBlockedStudents = () => {
    navigate("/hod/blocked-students");
    setIsOpen(false);
  };

  const handleSendNotification = () => {
    navigate("/hod/send-notification");
    setIsOpen(false);
  };
        ...
        <div className="w-full mt-8 md:mt-0">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="bg-white p-2 rounded-xl shadow-md">
              <FiBriefcase className="w-8 h-8 text-blue-700" />
            </div>
          ...
          <ul className="flex flex-col space-y-1">
            ...
            <li className="w-full">
              <button
                onClick={() => {
                  navigate("/hod/notification-history");
                  setIsOpen(false);
                }}
                className="w-full flex items-center px-4 py-3 text-left text-white hover:bg-blue-700 rounded-lg transition-all duration-200 font-medium"
              >
