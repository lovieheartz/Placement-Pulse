// Lightweight inline icons (lucide-style, currentColor) for the glass UI.
import React from "react";

export const ArrowUpRight = ({ className = "h-5 w-5", strokeWidth = 2 }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const ArrowRight = ({ className = "h-5 w-5", strokeWidth = 2 }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const Sparkle = ({ className = "h-6 w-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M12 2l1.8 5.6L19.5 9.4l-4.8 3.1L16 18l-4-3.4L8 18l1.3-5.5L4.5 9.4l5.7-1.8L12 2z" />
  </svg>
);

// 28x28 outline icons used in the hero stat cards
...
export const TrophyIcon = ({ className = "h-7 w-7" }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const Twitter = ({ className = "h-5 w-5" }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
// Material-style filled glyphs for the capability cards
export const MaterialIcon = ({ path, className = "h-6 w-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d={path} />
  </svg>
);
...
export const ICON_PATHS = {
  resume:
    "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm0 7V3.5L18.5 8H14zM8 13h8v2H8v-2zm0 4h5v2H8v-2z",
  interview:
    "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4zm8-2l-1.5-1.5L20 9l1.5 1.5L20 12z",
  test:
    "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14l-4-4 1.4-1.4L10 14.2l6.6-6.6L18 9l-8 8z",
  analytics:
